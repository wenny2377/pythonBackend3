...
class PatternAnalyzer:
    ...
    def analyze_user(self, user_id: str) -> list:
    ...
    def _write_pattern(self, user_id: str, action: str, zone_name: str,
                        time_slot: str, sample_count: int, items: list) -> dict:
        item_counts  = {}
        for item in items:
            item_counts[item] = item_counts.get(item, 0) + 1

        common_items = sorted(item_counts, key=item_counts.get, reverse=True)
